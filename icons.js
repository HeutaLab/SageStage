...
(function () {
  ...
  const I = {
    ...
    blur: `<rect x="4" y="6" width="16" height="12" rx="2" ${A}/>
      <path d="M7.5 10.5h9M7.5 13.5h9" opacity="0.55"/>
      <path d="M4 6h16M4 18h16"/>`,
    magnify: `<circle cx="10.5" cy="10.5" r="6" ${A}/>
      <path d="M8 10.5h5M10.5 8v5"/>
      <path d="M15 15l4.5 4.5"/>`,
    snip: `<path d="M4 8.5V6a1.5 1.5 0 0 1 1.5-1.5H8M16 4.5h2.5A1.5 1.5 0 0 1 20 6v2.5M20 15.5V18a1.5 1.5 0 0 1-1.5 1.5H16M8 19.5H5.5A1.5 1.5 0 0 1 4 18v-2.5"/>
      <rect x="8.5" y="8.5" width="7" height="7" rx="1" ${A}/>`,
    'desktop-ink': `<rect x="3" y="4" width="18" height="12.5" rx="2" ${A}/>
      <path d="M9 20.5h6M12 16.5v4"/>
      <path d="M6 13c1.7-3.6 2.9-4.9 3.6-4.2.8.8-1.3 3-.6 3.6.8.7 2.3-2.3 3.6-3 1-.5 1.8-.1 2.4.7"/>`,
